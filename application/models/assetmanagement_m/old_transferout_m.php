...
class old_transferout_m extends CI_Model {
  ...
  public function getIdMax_typeid(){
        ...
        return $result;
           ...
           public function tampil_tujuantransfer() {
        $sql = "select * from TBL_M_BRANCH";
        $query = $this->db->query($sql);
        $result = $query->result();
        return $result;
        ...
        $sql = "select distinct SEGMENT1, SEGMENT2, ' - '+SEGMENT3 as SEGMENT3 from TBL_M_LOCATION";
        $query = $this->db->query($sql);
        $result = $query->result();
        return $result;
    }
        ...
        $sql = "select count(*) from VW_ASSET";
        $query = $this->db->query($sql);
        $result = $query->result();
        return $result;
    }
