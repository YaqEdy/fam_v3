...
//AMOUNT cek TBL_T_PO_DTL_TOTAL, TBL_T_IAS
        $query4 = $this->db->query("SELECT DPP,PPN,PPH,DENDA,NILAI_DIBAYARKAN,DPP+PPN-DENDA AS TTL_BYR FROM  TBL_T_IAS WHERE ID_IAS=" . $ID_IAS);
...
//            print_r($NilaiIas);
            ...
            if ($NilaiTermin == $NilaiIas) {
                $Ias_old = $this->db->query("SELECT DPP,PPN,PPH,DENDA,NILAI_DIBAYARKAN FROM TBL_T_IAS WHERE ID_PO_DETAIL=" . $ID_PO_DETAIL . " order by CREATE_DATE asc")->result();
//                print_r(count($Ias_old));
                $iminus = -1;
                for ($d = 0; $d < count($Ias_old); $d++) {
//                foreach ($Ias_old as $old) {
                    if ($NilaiTermin - 1 == $d) {
                        $iminus = 1;
                    }
                    if ($d < $NilaiTermin - 1) {
                        ...
                        if ($result4->PPN > 0) {
                            ...
                            $arrdt[] = array(
                                ...
                                'INVOICE_AMOUNT' => $Ias_old[$d]->NILAI_DIBAYARKAN, //$result4->NILAI_DIBAYARKAN
                                ...
                                'AMOUNT' => $iminus * $Ias_old[$d]->PPN, //$result4->PPN
...
//                        'UMUR_FISKAL' => $dtl[$i]->umurfiskal, //ITEM CATEGORY //masih kosong
                        ...
                        if ($result4->PPH > 0) {
                            ...
                            $arrdt[] = array(
                                ...
                                'INVOICE_DATE' => date('Y-m-d h:i:s'),
                                'INVOICE_CURRENCY_CODE' => $hdr->Currency,
                                'INVOICE_AMOUNT' => $Ias_old[$d]->NILAI_DIBAYARKAN,
                                'TERMS_NAME' => 'Immediate',
                                'LIABILITY_ACCOUNT' => $result3->FLEX_VALUE_ . '-' . $dtl[$i]->AccountLiability . '-000000-00-0000-00-0000-0000-0000', //VENDOR paren-liability-9segmen ?
                                'INVOICE_DESCRIPTION' => $hdr->ProjectName, //NAMA PROJECT PR
                                'FAKTUR_PAJAK' => $faktur, //TBL_T_IAS_DOC=>NAMA_DOC=2(FAKTUR PAJAK)
                                ...
                                'AMOUNT' => $Ias_old[$d]->PPH, //$dtl->HARGA, //TAMBAH 1 ROW PPN
                                'AKUN_DISTRIBUSI' => $result3->FLEX_VALUE_ . '-1181000-000000-00-0000-00-0000-0000-0000', //AMBIL DARI COA PER ITEM(tunggu design table)=>SEMENTARA
...
//                            'UMUR_FISKAL' => $dtl[$i]->umurfiskal, //ITEM CATEGORY //masih kosong
                        ...
                        if ($result4->DENDA > 0) {
                            ...
                            $arrdt[] = array(
                                ...
                                'LINE_NUMBER' => $iiLine,
                                'LINE_TYPE_LOOKUP_CODE' => 'ITEM ', //ASER 'AWT' BARANG 'ITEM'
                                'AMOUNT' => $Ias_old[$d]->DENDA, //$dtl->HARGA, //TAMBAH 1 ROW PPN
...
//                            'UMUR_FISKAL' => $dtl[$i]->umurfiskal, //ITEM CATEGORY //masih kosong
                        ...
                        $arrdt[] = array(
                            ...
                            'LINE_NUMBER' => $iiLine,
                            'LINE_TYPE_LOOKUP_CODE' => 'ITEM ', //ASER 'AWT' BARANG 'ITEM'
                            'AMOUNT' => $iminus * $Ias_old[$d]->DPP, //$dtl->HARGA, //TAMBAH 1 ROW PPN 1182001
...
//                    'ITEM_DESCRIPTION' => '',
                        'ASSET_BOOK_NAME' => 'PNM COMMERCIAL BOOK', //$result3->PARENT . ' COM BOOK', //PAREN COM BOOK
//                        'ASSET_CATEGORY' => 108, //ITEM CATEGORY ->ID
//                        'JENIS_BARANG' => '01', //ITEM TYPE ->ID
//                        'UMUR_FISKAL' => 'C1', //ITEM CATEGORY //masih kosong
                        'ASSET_CATEGORY' => $dtl[$i]->ClassCode, //ITEM CATEGORY ->ID
                        'JENIS_BARANG' => $dtl[$i]->TypeCode, //ITEM TYPE ->ID
...
//                    'PROCESS_ID' => ''
                    ...
                    if ($result4->PPN > 0) {
                        ...
                        $arrdt[] = array(
                            ...
                            'INVOICE_DATE' => date('Y-m-d h:i:s'),
                            'INVOICE_CURRENCY_CODE' => $hdr->Currency,
                            'INVOICE_AMOUNT' => $result4->NILAI_DIBAYARKAN, //$result4->NILAI_DIBAYARKAN
                            'TERMS_NAME' => 'Immediate',
                            'LIABILITY_ACCOUNT' => $result3->FLEX_VALUE_ . '-' . $dtl[$i]->AccountLiability . '-000000-00-0000-00-0000-0000-0000', //VENDOR paren-liability-9segmen ?
                            'INVOICE_DESCRIPTION' => $hdr->ProjectName, //NAMA PROJECT PR
                            'FAKTUR_PAJAK' => $faktur, //TBL_T_IAS_DOC=>NAMA_DOC=2(FAKTUR PAJAK)
                            ...
                            'LINE_NUMBER' => $iiLine,
                            'LINE_TYPE_LOOKUP_CODE' => 'ITEM ', //ASER 'AWT' BARANG 'ITEM'
                            'AMOUNT' => $result4->PPN, //$result4->PPN
                            'AKUN_DISTRIBUSI' => $result3->FLEX_VALUE_ . '-1182000-000000-00-0000-00-0000-0000-0000', //AMBIL DARI COA PER ITEM(tunggu design table)=>SEMENTARA
                            'LINE_DESCRIPTION' => 'PPN', //NAMA ITEM PPN
//                        'ASSET_BOOK_NAME' => 'PNM COMMERCIAL BOOK', //$result3->PARENT . ' COM BOOK', //PAREN COM BOOK
//                        'ASSET_CATEGORY' => $dtl[$i]->ClassCode, //ITEM CATEGORY ->ID
