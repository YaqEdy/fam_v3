...
//        $this->param_or_where = $s_param_or_where;
    ...
    private function _get_datatables_query_print() {
        $this->db->select($this->column);
        $this->db->where($this->where);
        $this->db->like($this->like);
        $this->db->where_in($this->param_in, $this->where_in);
    ...
    function get_datatables_print($s_Table = null, $s_column = array(), $s_order = null, $s_where = array(), $s_like = array()
    , $s_where_in = array(), $s_param_in = null, $s_where_not_in = array(), $s_param_not_in = null, $s_or_where = array()) {
        $this->table = $s_Table;
        $this->column = $s_column;
        $this->order = $s_order;
        ...
        $this->_get_datatables_query_print();
        $query = $this->db->get();
        return $query->result();
    }
