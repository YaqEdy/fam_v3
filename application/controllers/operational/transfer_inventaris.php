...
class transfer_inventaris extends CI_Controller {
...
//        $this->load->model('zsessions_m');
    ...
    function home() {
        $menuId = $this->home_m->get_menu_id('operational/transfer_inventaris/home');
...
//            $data['statususer'] = $this->global_m->tampil_id_desk('sec_status_user', 'statususer_id', 'statususer_desc', 'statususer_id');
        ...
        $this->template->set('title', 'Transfer Inventaris');
        $this->template->load('template/template_dataTable', 'operational/transfer_inventaris/transfer_inventaris_v', $data);
    }
