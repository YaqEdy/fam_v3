...
//          $this->load->model('zsessions_m');
            ...
            $this->load->model('operational/transferin_m');
...
//           $this->load->model('datatables_custom');
    ...
    function home() {
        ...
        $data['item_branch'] = $this->transferin_m->tampil_branch();
        $data['item_div'] = $this->transferin_m->tampil_division();
        $data['item_tujuan'] = $this->transferin_m->tampil_tujuantransfer();
        $data['item_kota'] = $this->transferin_m->tampil_kota();
        $data['item_lokasi'] = $this->transferin_m->tampil_lokasi();
...
//            $data['statususer'] = $this->global_m->tampil_id_desk('sec_status_user', 'statususer_id', 'statususer_desc', 'statususer_id');
        ...
        $this->template->load('template/template_dataTable', 'operational/transferin_v', $data);
    }
...
//        $icolumn = array('HpsID');
       ...
       // $count_asset = $this->transferin_m->count_asset();
