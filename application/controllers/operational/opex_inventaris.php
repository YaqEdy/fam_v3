...
class opex_inventaris extends CI_Controller {
...
//        $this->load->model('zsessions_m');
    ...
    function home() {
        $menuId = $this->home_m->get_menu_id('operational/opex_inventaris/home');
...
//            $data['statususer'] = $this->global_m->tampil_id_desk('sec_status_user', 'statususer_id', 'statususer_desc', 'statususer_id');
        ...
        $this->template->set('title', 'Opex Inventaris');
        $this->template->load('template/template_dataTable', 'operational/opex_inventaris/opex_inventaris_v', $data);
    }
