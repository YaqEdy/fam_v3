...
class opex_biasa extends CI_Controller {
    ...
    function __construct() {
        ...
        if ($this->session->userdata("is_login") === FALSE) {
            ...
            $this->load->model('operational/opex_biasa_m');
    ...
    function home() {
        $menuId = $this->home_m->get_menu_id('operational/opex_biasa/home');
...
//            $data['statususer'] = $this->global_m->tampil_id_desk('sec_status_user', 'statususer_id', 'statususer_desc', 'statususer_id');
        ...
        $this->template->set('title', 'Data Operational Biasa  ');
        $this->template->load('template/template_dataTable', 'operational/opex_biasa_v', $data);
    }
...
//             $nestedData[] = $row["JNS_PERIODE"];
//             $nestedData[] = $row["START_PERIODE"];
//             $nestedData[] = $row["END_PERIODE"];
//             $nestedData[] = $row["NOTIF"];
...
//     }
     ...
     public function get_server_side() {    
       $icolumn = array('ID_ASSET', 'ITEM_ID', 'ItemName',  'QTY', 'TGL_ASSET', 'BranchID', 'BRANCH_DESC', 'DivisionID', 'DIV_DESC', 'ZONE_ID', 'ZoneName', 'AssetType', 'IMAGE_PATH', 'KONDISI', 'ID_ASSET_OLD', 'STATUS_TRANS', 'QR', 'ASSET_NUMBER', 'ASSET_DESC', 'JNS_PERIODE', 'START_PERIODE', 'END_PERIODE', 'NOTIF');
        //$iwhere = array('AssetType' => 0);
        $iorder = array('ID' => 'asc');
        $list = $this->datatables->get_datatables('VW_OPEX', $icolumn, $iorder);
            // print_r($list);
            // die();
        $data = array();
        $no = $_POST['start'];
        foreach ($list as $idatatables) {
            ...
            $row[] = $idatatables->START_PERIODE;
            $row[] = $idatatables->END_PERIODE;
            $row[] = $idatatables->NOTIF;
