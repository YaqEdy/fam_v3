...
class opex_inv extends CI_Controller {
    ...
    function __construct() {
        ...
        if ($this->session->userdata("is_login") === FALSE) {
            ...
            $this->load->model('operational/opex_inv_m');
    ...
    function home() {
        $menuId = $this->home_m->get_menu_id('operational/opex_inv/home');
...
//            $data['statususer'] = $this->global_m->tampil_id_desk('sec_status_user', 'statususer_id', 'statususer_desc', 'statususer_id');
        ...
        $this->template->set('title', 'Data Operational Inventaris  ');
        $this->template->load('template/template_dataTable', 'operational/opex_inv_v', $data);
    }
