...
class approval_kadiv extends CI_Controller {
...
//        $this->load->model('zsessions_m');
            ...
            $this->load->model('assetmanagement_m/approval_kadiv_m');
    ...
    function home() {
        $menuId = $this->home_m->get_menu_id('assetmanagement/approval_kadiv/home');
...
//            $data['statususer'] = $this->global_m->tampil_id_desk('sec_status_user', 'statususer_id', 'statususer_desc', 'statususer_id');
        ...
        $this->template->set('title', 'APPROVAL KADIV');
        $this->template->load('template/template_dataTable', 'assetmanagement_v/approval_kadiv_v', $data);
    }
...
//        print_r($requestData);die();
    ...
    public function get_dataapproval() { 
        $icolumn = array('ID', 'TGL_PENGAJUAN', 'STATUS','PIC', 'JML_ITEM', 'WIL_BALAI_LELANG', 'HARGA_PERKIRAAN','CREATE_BY','CREATE_DATE');
        $iwhere = array('STATUS' => 1);
        $iorder = array('ID' => 'asc');
...
//        $icolumn = array('HpsID');
  ...
  public function get_server_side_detail() {     
       
    $icolumn = array('ID','ID_ASSET','ID_ASSET_PENJUALAN', 'ZONE_ID', 'ZoneName', 'BranchID', 'BRANCH_DESC','ItemName','KONDISI');
   
    $where = $this->input->post('IDetail');
    $iwhere = array('ID_ASSET_PENJUALAN' => $where);
    $iorder = array('ID' => 'asc');
    $list = $this->datatables_custom->get_datatables('VW_ASSETS_JUAL', $icolumn, $iorder,$iwhere);
        // print_r($list);
        // die();
    $data = array();
    $no = $_POST['start'];
...
function savedatakabag (){
    ...
    $PARAMS=array(
        ...
        // $this->db->query("zsp_Create_PR_Group ?,?",$PARAMS);
     $model = $this->global_m->ubah('TBL_T_ASSETS_PENJUALAN', $PARAMS);
