...
class old_transferout extends CI_Controller {
...
//          $this->load->model('zsessions_m');
            ...
            $this->load->model('assetmanagement_m/old_transferout_m');
    ...
    function home() {
        $menuId = $this->home_m->get_menu_id('assetmanagement/old_transferout/home');
        ...
        $data['item_branch'] = $this->old_transferout_m->tampil_branch();
        $data['item_div'] = $this->old_transferout_m->tampil_division();
        $data['item_tujuan'] = $this->old_transferout_m->tampil_tujuantransfer();
        $data['item_kota'] = $this->old_transferout_m->tampil_kota();
        $data['item_lokasi'] = $this->old_transferout_m->tampil_lokasi();
...
//            $data['statususer'] = $this->global_m->tampil_id_desk('sec_status_user', 'statususer_id', 'statususer_desc', 'statususer_id');
        ...
        $this->template->load('template/template_dataTable', 'assetmanagement_v/old_transferout_v', $data);
    }
