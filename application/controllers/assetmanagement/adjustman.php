...
class adjustman extends CI_Controller {
...
//          $this->load->model('zsessions_m');
            ...
            $this->load->model('assetmanagement_m/adjustman_m');
    ...
    function home() {
        $menuId = $this->home_m->get_menu_id('assetmanagement/adjustman/home');
...
//            $data['statususer'] = $this->global_m->tampil_id_desk('sec_status_user', 'statususer_id', 'statususer_desc', 'statususer_id');
        ...
        $this->template->set('title', 'Adjustman & Evaluasi');
        $this->template->load('template/template_dataTable', 'assetmanagement_v/adjustman_v', $data);
    }
...
//datatable terimatransfer
    ...
    public function terima_asset(){
        ...
        $model = $this->global_m->simpan('TBL_T_ASSETS', $data,'ID',$id);
