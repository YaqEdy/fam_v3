...
class approval_kabag extends CI_Controller {
...
//        $this->load->model('zsessions_m');
            ...
            $this->load->model('assetmanagement_m/approval_kabag_m');
    ...
    function home() {
        $menuId = $this->home_m->get_menu_id('assetmanagement/approval_kabag/home');
...
//            $data['statususer'] = $this->global_m->tampil_id_desk('sec_status_user', 'statususer_id', 'statususer_desc', 'statususer_id');
        ...
        $this->template->set('title', 'APPROVAL KABAG');
        $this->template->load('template/template_dataTable', 'assetmanagement_v/approval_kabag_v', $data);
    }
