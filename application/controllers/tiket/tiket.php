...
//            $data['statususer'] = $this->global_m->tampil_id_desk('sec_status_user', 'statususer_id', 'statususer_desc', 'statususer_id');
        ...
        $icolumn = array('ID_TIKET','NO_SPD', 'SPD_PATH', 'TGL_PR', 'ASAL', 'TUJUAN', 'TGL_BERANGKAT', 'TGL_PULANG', 'AN_TIKET' , 'JNS_IDENTITAS', 'NO_KTP1', 'ID_KRY1','NO_KTP2', 'ID_KRY2', 'NO_KTP3', 'ID_KRY3');
//        $icolumn = array('HpsID');
        $iwhere = array();
        // $iwhere = array(
        ...
        foreach ($list as $idatatables) {
            ...
            $row[] = $idatatables->ASAL;
            $row[] = $idatatables->TUJUAN;
