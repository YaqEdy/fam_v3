...
class sec_user extends CI_Controller {
    ...
    public function sync_user_fam() {
        $this->api_m->sync_user_fam();
    }
...
//     }
    ...
    function tampil_data() {
        ...
        // print_r($idsm); die();
        $sql = "select nik, user_name, name, user_email, DivisionID, status, user_groupid, idsdm, ZoneID, PositionID, BranchID, user_id
                FROM [user]
