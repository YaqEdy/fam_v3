...
//            $data['statususer'] = $this->global_m->tampil_id_desk('sec_status_user', 'statususer_id', 'statususer_desc', 'statususer_id');
 ...
 //    }
    ...
    function get_server_side() {
        ...
        left join Mst_Provinsi c on a.IdProvinsi = c.IdProvinsi
        left join Mst_Kabupaten d on a.IdKabupaten = d.IdKabupaten
        left join TBL_CountryNew e on a.ID_Country = e.ID_Country where Status like '%" . $iStatus . "%'and City like '%" . $requestData['search']['value'] . "%'";
            }else if ($iSearch == '4') {
                $sql = "select a.Raw_ID, a.VendorID, a.VendorName, a.City, a.NamaRekening2, a.NamaBank2, a.NomorRekening2, a.NamaRekening3,  a.NamaBank3, a.NomorRekening3, a.ID_Country, a.ID_Branch, a.PKP, b.FLEX_VALUE, b.BRANCH_DESC, a.AFILIASI, a.NPWP, c.NamaProvinsi,
        d.NamaKabupaten, a.Terms, a.Currency, a.NomorRekening, a.NamaRekening, a.NamaBank, a.Image,
        a.Performance, a.VendorAlias, a.AlamatNPWP, a.AlamatSupplier,a.VendorAddress,a.IdProvinsi, a.IdKabupaten, 
        ...
        left join Mst_Provinsi c on a.IdProvinsi = c.IdProvinsi
        left join Mst_Kabupaten d on a.IdKabupaten = d.IdKabupaten
        left join TBL_CountryNew e on a.ID_Country = e.ID_Country where Status like '%" . $iStatus . "%'and CountryName like '%" . $requestData['search']['value'] . "%'";
            }else if ($iSearch == '5') {
                $sql = "select a.Raw_ID, a.VendorID, a.VendorName, a.City, a.NamaRekening2, a.NamaBank2, a.NomorRekening2, a.NamaRekening3,  a.NamaBank3, a.NomorRekening3, a.ID_Country, a.ID_Branch, a.PKP, b.FLEX_VALUE, b.BRANCH_DESC, a.AFILIASI, a.NPWP, c.NamaProvinsi,
        d.NamaKabupaten, a.Terms, a.Currency, a.NomorRekening, a.NamaRekening, a.NamaBank, a.Image,
        a.Performance, a.VendorAlias, a.AlamatNPWP, a.AlamatSupplier,a.VendorAddress,a.IdProvinsi, a.IdKabupaten, 
        ...
        left join Mst_Provinsi c on a.IdProvinsi = c.IdProvinsi
        left join Mst_Kabupaten d on a.IdKabupaten = d.IdKabupaten
        left join TBL_CountryNew e on a.ID_Country = e.ID_Country where Status like '%" . $iStatus . "%'and ID_Branch like '%" . $requestData['search']['value'] . "%'";
            }else if ($iSearch == '6') {
                $sql = "select a.Raw_ID, a.VendorID, a.VendorName, a.City, a.NamaRekening2, a.NamaBank2, a.NomorRekening2, a.NamaRekening3,  a.NamaBank3, a.NomorRekening3, a.ID_Country, a.ID_Branch, a.PKP, b.FLEX_VALUE, b.BRANCH_DESC, a.AFILIASI, a.NPWP, c.NamaProvinsi,
        d.NamaKabupaten, a.Terms, a.Currency, a.NomorRekening, a.NamaRekening, a.NamaBank, a.Image,
        a.Performance, a.VendorAlias, a.AlamatNPWP, a.AlamatSupplier,a.VendorAddress,a.IdProvinsi, a.IdKabupaten, 
        ...
        left join Mst_Provinsi c on a.IdProvinsi = c.IdProvinsi
        left join Mst_Kabupaten d on a.IdKabupaten = d.IdKabupaten
        left join TBL_CountryNew e on a.ID_Country = e.ID_Country where Status like '%" . $iStatus . "%'and AccountLiability like '%" . $requestData['search']['value'] . "%'";
            }else if ($iSearch == '7') {
                $sql = "select a.Raw_ID, a.VendorID, a.VendorName, a.City, a.NamaRekening2, a.NamaBank2, a.NomorRekening2, a.NamaRekening3,  a.NamaBank3, a.NomorRekening3, a.ID_Country, a.ID_Branch, a.PKP, b.FLEX_VALUE, b.BRANCH_DESC, a.AFILIASI, a.NPWP, c.NamaProvinsi,
        d.NamaKabupaten, a.Terms, a.Currency, a.NomorRekening, a.NamaRekening, a.NamaBank, a.Image,
        a.Performance, a.VendorAlias, a.AlamatNPWP, a.AlamatSupplier,a.VendorAddress,a.IdProvinsi, a.IdKabupaten, 
        ...
        left join Mst_Provinsi c on a.IdProvinsi = c.IdProvinsi
        left join Mst_Kabupaten d on a.IdKabupaten = d.IdKabupaten
        left join TBL_CountryNew e on a.ID_Country = e.ID_Country where Status like '%" . $iStatus . "%'and AccountPrepayment like '%" . $requestData['search']['value'] . "%'";
            }else if ($iSearch == '8') {
                $sql = "select a.Raw_ID, a.VendorID, a.VendorName, a.City, a.NamaRekening2, a.NamaBank2, a.NomorRekening2, a.NamaRekening3,  a.NamaBank3, a.NomorRekening3, a.ID_Country, a.ID_Branch, a.PKP, b.FLEX_VALUE, b.BRANCH_DESC, a.AFILIASI, a.NPWP, c.NamaProvinsi,
        d.NamaKabupaten, a.Terms, a.Currency, a.NomorRekening, a.NamaRekening, a.NamaBank, a.Image,
        a.Performance, a.VendorAlias, a.AlamatNPWP, a.AlamatSupplier,a.VendorAddress,a.IdProvinsi, a.IdKabupaten, 
        ...
        left join Mst_Provinsi c on a.IdProvinsi = c.IdProvinsi
        left join Mst_Kabupaten d on a.IdKabupaten = d.IdKabupaten
        left join TBL_CountryNew e on a.ID_Country = e.ID_Country where Status like '%" . $iStatus . "%'and NPWP like '%" . $requestData['search']['value'] . "%'";
            }else if ($iSearch == '9') {
                $sql = "select a.Raw_ID, a.VendorID, a.VendorName, a.City, a.NamaRekening2, a.NamaBank2, a.NomorRekening2, a.NamaRekening3,  a.NamaBank3, a.NomorRekening3, a.ID_Country, a.ID_Branch, a.PKP, b.FLEX_VALUE, b.BRANCH_DESC, a.AFILIASI, a.NPWP, c.NamaProvinsi,
        d.NamaKabupaten, a.Terms, a.Currency, a.NomorRekening, a.NamaRekening, a.NamaBank, a.Image,
        a.Performance, a.VendorAlias, a.AlamatNPWP, a.AlamatSupplier,a.VendorAddress,a.IdProvinsi, a.IdKabupaten, 
        ...
        left join Mst_Provinsi c on a.IdProvinsi = c.IdProvinsi
        left join Mst_Kabupaten d on a.IdKabupaten = d.IdKabupaten
        left join TBL_CountryNew e on a.ID_Country = e.ID_Country where Status like '%" . $iStatus . "%'and AlamatSupplier like '%" . $requestData['search']['value'] . "%'";
            }else {
                $sql = "select a.Raw_ID, a.VendorID, a.VendorName, a.City, a.NamaRekening2, a.NamaBank2, a.NomorRekening2, a.NamaRekening3,  a.NamaBank3, a.NomorRekening3, a.ID_Country, a.ID_Branch, a.PKP, b.FLEX_VALUE, b.BRANCH_DESC, a.AFILIASI, a.NPWP, c.NamaProvinsi,
        d.NamaKabupaten, a.Terms, a.Currency, a.NomorRekening, a.NamaRekening, a.NamaBank, a.Image,
        a.Performance, a.VendorAlias, a.AlamatNPWP, a.AlamatSupplier,a.VendorAddress,a.IdProvinsi, a.IdKabupaten, 
        ...
        left join TBL_CountryNew e on a.ID_Country = e.ID_Country where Status like '%" . $iStatus . "%'";
                ...
                $sql .= "or ID_Branch like '%" . $requestData['search']['value'] . "%'";
                $sql .= "or AccountLiability like '%" . $requestData['search']['value'] . "%'";
                $sql .= "or AccountPrepayment like '%" . $requestData['search']['value'] . "%'";
                $sql .= "or NPWP like '%" . $requestData['search']['value'] . "%'";
                $sql .= "or AlamatSupplier like '%" . $requestData['search']['value'] . "%'";
