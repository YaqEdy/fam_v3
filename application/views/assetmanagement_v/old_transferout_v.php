...
<script>
    ...
    "serverSide": true,
    "ajax": {
                    url: "<?php echo base_url("/assetmanagement/old_transferout/get_server_side"); ?>", // json datasource
  ...
  function terima(data){
     ...
     $.ajax({
        ...
        data : {id: data},
        dataType: "JSON",
        url: "<?php echo base_url("/assetmanagement/old_transferout/terima_asset"); ?>", // json datasource
        success: function (e) {
         location.reload();
         if(e.act){
 ...
 function getSaveTransfer() {
    ...
    $.ajax({
        ...
        data : {sTbl: i_clsUpdate},
        dataType: "JSON",
        url: "<?php echo base_url("/assetmanagement/old_transferout/savedatatransfer"); ?>", // json datasource
        success: function (e) {
         location.reload();
         if(e.act){
            UIToastr.init(e.tipePesan, e.pesan);
...
function getfamdata(){
    ...
    "serverSide": true,
    "ajax": {
                    url: "<?php echo base_url("/assetmanagement/old_transferout/get_datatransfer"); ?>", // json datasource
                    type: "post", // method  , by default get
                    data: function (z) {
                        z.sStatus = iStatus;
                        z.sSearch = iSearch;
...
function getfamdata_transfer(){
    ...
    "serverSide": true,
    "ajax": {
                    url: "<?php echo base_url("/assetmanagement/old_transferout/get_terimatransfer"); ?>", // json datasource
                    type: "post", // method  , by default get
                    data: function (z) {
                        z.sStatus = iStatus;
                        z.sSearch = iSearch;
...
function getfamdataku(){
    ...
    "serverSide": true,
    "ajax": {
                    url: "<?php echo base_url("/assetmanagement/old_transferout/get_server_side_asset_dataku"); ?>", // json datasource
                    type: "post", // method  , by default get
                    data: function (z) {
                        // console.log(z);
