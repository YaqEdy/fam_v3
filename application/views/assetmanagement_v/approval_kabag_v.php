...
console.log($("#ID").text());
    $.ajax({
        ...
        data : {ID : $("#ID").text()},
        dataType: "JSON",
        url: "<?php echo base_url("/assetmanagement/approval_kabag/rejectdata"); ?>", // json datasource
        success: function (e) {
         // location.reload();
         if(e.act){
            UIToastr.init(e.tipePesan, e.pesan);
...
console.log($("#ID").text());
    $.ajax({
        ...
        data : {ID : $("#ID").text()},
        dataType: "JSON",
        url: "<?php echo base_url("/assetmanagement/approval_kabag/approvedata"); ?>", // json datasource
        success: function (e) {
         // location.reload();
         if(e.act){
            UIToastr.init(e.tipePesan, e.pesan);
...
function getfamdetail_pengajuan(){
    ...
    //                // set the initial value
                ...
                "serverSide": true,
                "ajax": {
                    url: "<?php echo base_url("/assetmanagement/approval_kabag/get_server_side_detail"); ?>", // json datasource
...
$('#table_approval tbody').on('click', '#btnDetail', function () {
    ...
    "serverSide": true,
    "ajax": {
                    url: "<?php echo base_url("/assetmanagement/approval_kabag/get_dataapproval"); ?>", // json datasource
                    type: "post", // method  , by default get
                    data: function (z) {
                        z.sStatus = iStatus;
                        z.sSearch = iSearch;
