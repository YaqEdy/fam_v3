        ...
        <div class="modal-body">
            <form enctype="multipart/form-data" id="formVendorList">
                ...
                <div class="validator-form form-horizontal">
                   ...
                   <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label col-sm-4">Supplier Name<span class="required" aria-required="true"> * </span></label>
                            <div class="col-sm-8">
                             <input type="text" placeholder="Example.PT" class="form-control" required id="id_VendorName" name="VendorName">
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-sm-4">Supplier Name Alias<span class="required" aria-required="true"> * </span> </label>
                        <div class="col-sm-8">
                         <input type="text" placeholder="PT.Example" class="form-control" required id="id_VendorAlias" name="VendorAlias">
                     </div>
                 </div>
             </div>
...
<div class="col-md-4">
    <div class="form-group">
        <label class="control-label col-sm-4">City<span class="required" aria-required="true"> * </span></label>
        <div class="col-sm-8">
...
<div class="col-md-4">
<div class="form-group">
    <label class="control-label col-sm-4">Country<span class="required" aria-required="true"> * </span></label>
    <div class="col-sm-8">
...
<div class="col-md-4">
<div class="form-group">
    <label class="control-label col-sm-4">Account Liability<span class="required" aria-required="true"> * </span></label>
    <div class="col-sm-8">
...
<div class="col-md-4">
<div class="form-group">
    <label class="control-label col-sm-4">Terms<span class="required" aria-required="true"> * </span></label>
    <div class="col-sm-8">
...
<div class="col-md-4">
<div class="form-group">
    <label class="control-label col-sm-4">Currency<span class="required" aria-required="true"> * </span></label>
    <div class="col-sm-8">
...
<div class="col-md-4">
<div class="form-group">
    <label class="control-label col-sm-4">Account Prepayment<span class="required" aria-required="true"> * </span></label>
    <div class="col-sm-8">
...
<div class="col-md-4">
<div class="form-group">
    <label class="control-label col-sm-4">Uploud Document (Zip) (MAX 5MB)</label>
    <div class="col-sm-8">
...
<div class="col-md-4">
    <div class="form-group">
        <label class="control-label col-sm-4">Alamat NPWP<span class="required" aria-required="true"> * </span></label>
        <div class="col-md-8">
...
<div class="col-md-4">
    <div class="form-group">
        <label class="control-label col-sm-4">Alamat Supplier<span class="required" aria-required="true"> * </span></label>
        <div class="col-md-8">
...
<div class="col-md-4">
    <div class="form-group">
        <label class="control-label col-sm-4">Address1<span class="required" aria-required="true"> * </span></label>
        <div class="col-md-8">
...
$("#btnAdd").click(function () {
    ...
    $('#mdl_Update').find('.modal-title').text('Add Vendor');
