                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        foreach ($dd_status as $k) :
                                                            $data[$k->id] = $k->status;
                                                        endforeach;
                                                        echo form_dropdown('id_status_dari', $data, '', 'id="id_status_dari" name="id_status_dari" class="form-control" required');
                                                        ?>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        foreach ($dd_status as $k) :
                                                            $data[$k->id] = $k->status;
                                                        endforeach;
                                                        echo form_dropdown('id_status_ke', $data, '', 'id="id_status_ke" name="id_status_ke" class="form-control" required');
                                                        ?>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        $data[''] = '--Select--';
                                                         foreach ($dd_tipe as $k) :
                                                            ...
                                                            endforeach;
                                                            echo form_dropdown('ID_TYPE', $data, '--Select--', 'id="id_tipe" name="id_tipe" class="form-control" required');
                                                        ?>
                                                     </div>

                                                     <div class="form-group">
                                                        <label>Min HPS</label> <span class="required">*</span>
                                                        <input required="required" class="form-control" id="id_min_hps" name="id_min_hps" type="number" min="1"  step="1" />
                                                    </div>

                                                    <div class="form-group">
                                                        <label>Max HPS</label> <span class="required">*</span>
                                                        <input required="required" class="form-control" id="id_max_hps" name="id_max_hps" type="number" min="1"  step="1" />
                                                    </div>
