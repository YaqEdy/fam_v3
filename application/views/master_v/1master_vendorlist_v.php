...
<div class="col-md-4">
    <div class="form-group">
        ...
        <div class="col-sm-8">
         <select class="form-control input-sm" type="text" id="id_city" name="city">
            <option value="" >--Select--</option>
...
<div class="form-group">
    ...
    <div class="col-sm-8">
     <select class="form-control input-sm" type="text" id="id_ID_Branch" name="ID_Branch" multiple="multiple">
        <option value="" >--Select--</option>
        <?php foreach ($item_branch as $row) { ?>
            <option value="<?php echo $row->FLEX_VALUE; ?>"><?php echo $row->BRANCH_DESC; ?></option>
        <?php } ?>
