 ...
 function statusAdd(e){
    ...
    $('#table_gridType').on('click', '#btnAktiv', function () {
        ...
        $.ajax({
          ...
          cache:false,
          dataType: "JSON",
      url: "<?php echo base_url("/master/master_itemtype/ajax_UpdateStatusType"); ?>", // json datasource
    ...
    $(".status").hide();
      ...
      function clickUpdate(){
        ...
        $.ajax({
          ...
          cache:false,
          dataType: "JSON",
      url: "<?php echo base_url("/master/master_itemtype/ajax_UpdateType"); ?>", // json datasource
      data: { sTbl: i_clsUpdate },
      success: function (e) {
        console.log(e);
        if(e.msgType==true){
...
//                // set the initial value
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo base_url("/master/master_itemtype/get_server_side"); ?>", // json datasource
