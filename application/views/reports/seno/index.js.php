<script>
    ...
    function loadTablePenilaianVendor() {
        dataTable = $('#table_report').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo base_url("/reports/seno/list_report"); ?>", // json datasource
    ...
    $( "#export_excel" ).click(function() {
        submit_post_via_hidden_form(
            '<?php echo base_url("/reports/seno/downloadReport"); ?>',
            {
                order : '',
                start: 0,
                search : '',
    ...
    $( "#export_pdf" ).click(function() {
        submit_post_via_hidden_form(
            '<?php echo base_url("/reports/seno/downloadReportPDF"); ?>',
            {
                order : '',
                start: 0,
                search : '',
