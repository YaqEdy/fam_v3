                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group col-md-2">
                                         <center><label><b>Tanggal Berangkat</b></label>
                                            <div class="input-group"> 
                                               <input class="form-control e date-picker" size="16" type="date" id="tanggal_berangkat" name="tanggal_berangkat" />&nbsp;
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="input-group col-md-2">
                                                            <center><label><b>Tanggal Pulang</b></label>
                                                                <div class="input-group"> 
                                                                   <input class="form-control e date-picker" size="16" type="date" value="" id="tanggal_pulang" name="tanggal_pulang" />&nbsp;
                                                                   <span class="input-group-btn" style='vertical-align: top;'>
