...
<script>
    ...
    function getfamtransfer() {
        dataTable1 = $('#idTabelBarang').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo base_url("/operational/transferin/get_server_side"); ?>", // json datasource
...
// console.log(ee);
    ...
    function terima(data) {
        ...
        $.ajax({
            ...
            data: {id: data},
            dataType: "JSON",
            url: "<?php echo base_url("/operational/transferin/terima_asset"); ?>", // json datasource
            success: function (e) {
                location.reload();
                if (e.act) {
    ...
    function getSaveTransfer() {
        ...
        $.ajax({
            ...
            data: {sTbl: i_clsUpdate},
            dataType: "JSON",
            url: "<?php echo base_url("/operational/transferin/savedatatransfer"); ?>", // json datasource
            success: function (e) {
                location.reload();
                if (e.act) {
                    UIToastr.init(e.tipePesan, e.pesan);
    ...
    function getfamdata() {
        dataTable = $('#table_asset').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo base_url("/operational/transferin/get_datatransfer"); ?>", // json datasource
                type: "post", // method  , by default get
                data: function (z) {
                    z.sStatus = iStatus;
                    z.sSearch = iSearch;
    ...
    function getfamdata_transfer() {
        dataTable = $('#table_asset_transfer').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo base_url("/operational/transferin/get_terimatransfer"); ?>", // json datasource
                type: "post", // method  , by default get
                data: function (z) {
                    z.sStatus = iStatus;
                    z.sSearch = iSearch;
    ...
    function getfamdataku() {
        ...
        dataTable = $('#table_gridItemProcess').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo base_url("/operational/transferin/get_server_side_asset_dataku"); ?>", // json datasource
                type: "post", // method  , by default get
                data: function (z) {
                    // console.log(z);
