                        ...
                        <div class="scroller" style="height:400px; ">
                            ...
                            <!-- <div class="row"> -->
                                <!-- <div class="col-md-4"> -->
                                    ...
                                    <a class="btn btn-sm btn-warning" href="#" id="btnAdd" data-toggle="modal" data-target="#myadd" onclick="dd_Zone('B')"><i class="fa fa-eye"></i>&nbsp;Lihat</a>
                                    <a class="btn btn-sm btn-warning" href="<?php echo base_url("/procurement/hps/downloadWord"); ?>" download><i class="fa fa-refresh"></i>&nbsp;Refresh</a>
                                    ...
                                    <table class="table table-striped table-bordered table-hover text_kanan" id="table_gridHPS">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class='row-md-5'>Tanggal Request</th>
                                                <th class='row-md-5'>Divisi Request</th>
                                                <th class='row-md-6'>Nama Barang</th>
                                                <th class='row-md-5'>Spesifikasi</th>
                                                <th class='row-md-4'>Jumlah Barang</th>
                                                <th class='row-md-4'>Status Tiket</th>
