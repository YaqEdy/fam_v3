                            ...
                            <form role="form" id="form<?php echo $l; ?>" class="form" method="post" id="id_from_sec_group_user" action="<?php echo base_url('procurement/po/savedata'); ?>">
                                ...
                                <div class="m-portlet__body col-md-12">
                                    ...
                                    <div class="form-group m-form__group col-md-4">
                                        ...
                                        <input type="hidden" class="form-control m-input" id="hargatotal<?php echo $l ?>" aria-describedby="textHelp" placeholder="Sub Total" name="subtotal" readonly="">
                                    </div>
                                    <div class="form-group m-form__group col-md-4">
        ...
        <?php } ?>
            ...
            <?php if (trim($po->ReqTypeID) != '3') {
                ...
                $ihidden = "";
                                                        ...
                                                        <td class="<?php echo $ihidden ?>"><input class="date-picker" type="text" name="start_periode[]" id="start_periode<?php echo $i ?>" value="<?php echo $list->START_PERIODE ?>"></td>
                                                        <td class="<?php echo $ihidden ?>"><input class="date-picker" type="text" name="end_periode[]" id="end_periode<?php echo $i ?>" value="<?php echo $list->END_PERIODE ?>"></td>
                                                        ...
                                                        <td><input type="text" name="satuan_X[]" class="satuan_X<?php echo $l; ?>" id="satuan_X<?php echo $i ?>" value="<?php echo "Rp " . number_format($list->HargaHPS, 2, ',', '.') ?>"></td>
                                                        <td><input type="text" name="hargatotal_X[]" class="total_X<?php echo $l; ?>" id="total_X<?php echo $i ?>" value="<?php echo "Rp " . number_format($list->total, 2, ',', '.') ?>"></td>
            ...
            <?php $i++;
                                ...
                                <div class="tanda termin<?php echo $l; ?>">
                                    <div class="m-portlet__body col-md-12">
                                        ...
                                        <div class="form-group m-form__group col-md-3">
                                            <label for="exampleInputtext1">Persentase Brg</label><input type="number" class="form-control m-input" name="persentaseBrg[]" id="presentaseBrgId<?php echo $l; ?>" aria-describedby="textHelp" placeholder="Persentase Brg">
                                        </div>
                                    </div>
                                </div>
...
//    alert(num);
        ...
        if (tmp != 100 || tmp2 != 100) {
            alert("Jumlah Persentase maupun Persentase Brd harus 100");
            return false;
        }
